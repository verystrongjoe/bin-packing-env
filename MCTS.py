...
class MCTS:
	...
	def moveToLeaf(self):
		...
		while not currentNode.isLeaf():
			...
			for idx, (action, edge) in enumerate(currentNode.edges):
				...
				logging.info('action: %d (%d)... N = %d, P = %f, nu = %f, adjP = %f, W = %f, Q = %f, U = %f, Q+U = %f'
			...
			logging.info('action with highest Q + U...%d', simulationAction)
	...
	def backFill(self, leaf, value, breadcrumbs):
		...
		for edge in breadcrumbs:
			...
			logging.info('updating edge with value %f for player %d... N = %d, W = %f, Q = %f'
				, value * direction
				, playerTurn
				, edge.stats['N']
				, edge.stats['W']
			...
			edge.outNode.state.render(logging)
